...
splitLong <- function(to.translate){
    if(nchar(curlEscape(to.translate)) > 1900){
        ...
        slice.at <- which(min(abs(period.inds - 300)) == abs(period.inds - 300)) - 1
...
"\u25CA", "\u2660", "\u2663", "\u2665"),
                       c("quot", "amp", "apos",
"lt", "gt", "nbsp", "iexcl", "cent", "pound", "curren", "yen",
...
"oline", "frasl", "euro", "image", "weierp", "real", "trade",
"alefsym", "larr", "uarr", "rarr", "darr", "harr", "crarr", "lArr",
...
"vellip", "lceil", "rceil", "lfloor", "rfloor", "lang", "rang", "loz",
"spades", "clubs", "hearts") )
